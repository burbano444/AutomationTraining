...
//PRUEBAS EN BODY
  it('API testing name', () => {
    ...
    cy.request('GET','https://pokeapi.co/api/v2/pokemon/pikachu') //Especificando tipo de consulta
    .its('body.name').should('equal',"nobita")
  })
...
//CONSULTAR DOS CAMPOS
  it('API testing type', () => {
    ...
    .its('body.name').should('equal',"pikachu")
    cy.request('GET','https://pokeapi.co/api/v2/pokemon/pikachu') //Especificando tipo de consulta
    .its('body.types[0].type.name').should('equal',"electric")
  })
...
//SWAGGER https://petstore.swagger.io/
  it('Fixtures swagger mascota', () => {
    ...
    //ADELANTANDO AL TEMA: Declaro el objeto body en "tc1_body.json" y con fixture se lo asigno a la vble body
    cy.fixture('tc1_body').then((body)=>{ 
